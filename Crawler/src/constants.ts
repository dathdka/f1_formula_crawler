...
const crawlSelector = {
  ...
  START_GRID_INFO: "body > div.site-wrapper > main > article > div > div.ResultArchiveContainer > div.resultsarchive-wrapper > div.resultsarchive-content.group > div.resultsarchive-col-right > table > tbody > tr",
  START_GRID_POSITION: "td:nth-child(2)",
  START_GRID_FIRST_NAME:".first-name",
  START_GRID_LAST_NAME:".last-name",
  FASTEST_LAPS_RESULT:
    "body > div.site-wrapper > main > article > div > div.ResultArchiveContainer > div.resultsarchive-wrapper > div.resultsarchive-content.group > div.resultsarchive-col-right > table > tbody > tr",
